...
public class PROM82S131Specs implements PROMSpecs {

	public static final String PROM_TYPE = "82S131";

	// @formatter:off
    private static final String[] LABELS_IN =  {  "a6",  "a5",  "a4",  "a3",  "a0",  "a1",  "a2",    null,  null,  null,  null,  null,  "a8",  "a7" };
    private static final String[] LABELS_O  =  {  null,  null,  null,  null,  null,  null,  null,    "o4",  "o3",  "o2",  "o1",  null,  null,  null };
    private static final String[] LABELS_OE =  {  null,  null,  null,  null,  null,  null,  null,    null,  null,  null,  null,  "oe1", null,  null };
	// @formatter:on
